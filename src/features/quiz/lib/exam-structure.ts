...
/**
 * Assigns Teil metadata to a flat array of questions based on the exam structure. The first
 * question of each Teil gets the title and instruction. All questions in the Teil get the teil
 * number.
 */
